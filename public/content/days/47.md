...
![](/content/res/Day46-60/pycharm-vote-project.png)
...
3. 运行项目，在浏览器中访问`http://127.0.0.1:8000/admin`，输入刚才创建的超级用户账号和密码进行登录。
   ...
   ![](/content/res/Day46-60/django-admin-login.png)

   登录后进入管理员操作平台。

   ![](/content/res/Day46-60/django-admin-apps.png)
...
4. 注册模型类。
   ...
   ![](/content/res/Day46-60/django-admin-models.png)
...
5. 对模型进行CRUD操作。
   ...
   - 添加学科。
       ...
       ![](/content/res/Day46-60/django-admin-add-model.png)

   - 查看所有学科。

       ![](/content/res/Day46-60/django-admin-view-models.png)

   - 删除和更新学科。

       ![](/content/res/Day46-60/django-admin-delete-update-model.png)
...
6. 注册模型管理类。
   ...
   ![](/content/res/Day46-60/django-admin-view-models-subject.png)
   
   ![](/content/res/Day46-60/django-admin-view-models-teacher.png)
