...
![](/content/res/Day46-60/web-application.png)
...
![](/content/res/Day46-60/http-request.png)

HTTP响应（响应行+响应头+空行+消息体）：

![](/content/res/Day46-60/http-response.png)
...
4. 用PyCharm打开创建好的Djang项目，并为其添加虚拟环境。
   ...
   ![](/content/res/Day46-60/pycharm-django-project.png)
   ...
   ![pycharm-django-virtual-environment](/content/res/Day46-60/pycharm-django-virtual-environment.png)
...
5. 安装项目依赖项。
   ...
   ![](/content/res/Day46-60/pycharm-install-django.png)
...
6. 启动Django自带的服务器运行项目。
   ...
   ![](/content/res/Day46-60/pycharm-django-server.png)

   方法二：在“Run”菜单选择“Edit Configuration”，配置运行“Python”程序运行项目（适用于专业版和社区版PyCharm）。

   ![](/content/res/Day46-60/pycharm-python-manage.png)
...
7. 查看运行效果。
  ...
  在浏览器中输入`http://127.0.0.1:8000`访问我们的服务器，效果如下图所示。
   ...
   ![](/content/res/Day46-60/django-index-1.png)
...
8. 修改项目的配置文件`settings.py`。
   ...
   ![](/content/res/Day46-60/django-index-2.png)
...
1. 在项目目录下创建名为templates文件夹。
   ...
   ![](/content/res/Day46-60/pycharm-django-template.png)
