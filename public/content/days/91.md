...
![](/content/res/Day91-100/git-logo.png)
...
![](/content/res/Day91-100/git_repository.png)
...
![](/content/res/Day91-100/gitlab-about.png)
...
![](/content/res/Day91-100/gitee-project-index.png)
...
4. 分支**变基**。分支合并操作可以将多个分支上的工作成果最终合并到一个分支上，但是再多次合并操作之后，分支可能会变得非常的混乱和复杂，为了解决这个问题，可以使用`git rebase`操作来实现分支变基。如下图所示，当我们希望将`master`和`dev`上的工作成果统一到一起的时候，也可以使用变基操作。
   ...
   ![](/content/res/Day91-100/git-rebase.png)
...
4. `git reset`：回退到指定的版本。该命令主要有三个参数，如下图所示。
   ...
   ![](/content/res/Day91-100/git-reset.png)
...
5. 在线发起一次合并请求（通常称之为**Pull Request**，有的地方称为**Merge Request**），请求将自己的工作成果合并到`master`分支，合并之后可以删除该分支。
   ...
   ![](/content/res/Day91-100/gitee-pull-request.png)
...
![](/content/res/Day91-100/git-flow.png)
...
![](/content/res/Day91-100/git-flow-detail.png)
...
![](/content/res/Day91-100/gitlab-new-issue.png)
...
![](/content/res/Day91-100/jenkins_new_project.png)
