...
![](/content/res/Day91-100/web-application.png)
...
![](/content/res/Day91-100/django_request_response_cycle.png)
...
![](/content/res/Day91-100/mvc.png)

### HTTP请求和响应

#### HTTP请求 = 请求行+请求头+空行+[消息体]

![](/content/res/Day91-100/http-request.png)

#### HTTP响应 = 响应行+响应头+空行+消息体

![](/content/res/Day91-100/http-response.png)
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   ![](/content/res/Day91-100/click-jacking.png)

![](/content/res/Day91-100/builtin-middlewares.png)
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   ![](/content/res/Day91-100/rbac-basic.png)

   ![](/content/res/Day91-100/rbac-full.png)
...
![](/content/res/Day91-100/celery_architecture.png)
...
- Selenium IDE：嵌入到浏览器的插件，可以录制和回放脚本。
  ...
  ![](/content/res/Day91-100/selenium_ide.png)
